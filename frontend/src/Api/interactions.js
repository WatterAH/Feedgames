...
export const likePost = async (id_user, id_post, username, user_post) => {
...
export const dontLikePost = async (id_user, id_post, username, user_post) => {
  const body = { id_user, id_post, username, user_post };
...
export const savePost = async (id_user, id_post) => {
...
export const dontSavePost = async (id_user, id_post) => {
  const body = { id_user, id_post };
...
export const followUser = async (id_follower, id_followed, username) => {
...
export const dontFollowUser = async (id_follower, id_followed, username) => {
  const body = { id_follower, id_followed, username };
